...
namespace BHive
{
	...
	void AnimationStateTransition::Update(const AnimPlayerContext &context)
	{
	...
	bool AnimationStateTransition::AreConditionsSatisfied(const AnimPlayerContext &context) const
	{
	...
	void AnimationStateTransition::ExecuteImpl(const AnimPlayerContext &context, std::any &out_result)
	{
