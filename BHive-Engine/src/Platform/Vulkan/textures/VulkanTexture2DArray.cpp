...
namespace BHive
{
		  ...
		  mInfo(specification)
	{
		...
		mImage.Create(
			width, height, depth, vk::ImageType::e2D, vk::ImageViewType::e2DArray, format, vk::ImageUsageFlagBits::eSampled | vk::ImageUsageFlagBits::eTransferDst, vk::ImageAspectFlagBits::eColor,
			sampler_info);
	}
