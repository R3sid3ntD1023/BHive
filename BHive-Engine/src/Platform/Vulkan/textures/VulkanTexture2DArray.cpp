...
namespace BHive
{
		  ...
		  mCreateInfo(specification)
	{
		...
		mImage.Create(
			width, height, depth, vk::ImageType::e2D, vk::ImageViewType::e2DArray, api_info.Format, vk::ImageUsageFlagBits::eSampled | vk::ImageUsageFlagBits::eTransferDst, vk::ImageAspectFlagBits::eColor,
			sampler_info);
	}
