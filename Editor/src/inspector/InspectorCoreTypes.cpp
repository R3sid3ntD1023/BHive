...
namespace BHive
{
    ...
    bool Inspector_String::Inspect(rttr::variant &var, bool read_only, const meta_getter &get_meta_data)
    {
        ...
        if (ImGui::InputText("##", &data, ImGuiInputTextFlags_EnterReturnsTrue | ImGuiInputTextFlags_AutoSelectAll))
        {
            var = data;
            return true;
        }
    ...
    bool Inspector_StdVector::Inspect(rttr::variant &var, bool read_only, const meta_getter &get_meta_data)
    {
        ...
        static auto treeflags = ImGuiTreeNodeFlags_SpanAvailWidth | ImGuiTreeNodeFlags_AllowOverlap |
        ...
        if (ImGui::TreeNodeEx("##Elements", treeflags))
        {
            ...
            for (size_t i = 0; i < size; i++)
            {
                ...
                // drawlist->AddRectFilled(item_rect.Min, item_rect.Max, ImGui::GetColorU32({.15f, .15f, .15f, 1.f}));
    ...
    bool Inspector_StdMap::Inspect(rttr::variant &var, bool read_only, const meta_getter &get_meta_data)
    {
