...
#define EVENT(cls, flags) \
	public:\
		int GetCategoryFlags() const override { return flags; }\
		uint64_t GetType() const override { return GetStaticType();}\
		static uint64_t GetStaticType() { return typeid(cls).hash_code();}
