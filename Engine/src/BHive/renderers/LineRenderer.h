...
namespace BHive
{
	...
	struct LineRenderer
	{
		...
		static BHIVE void DrawArc(float radius, uint32_t sides, float start, float end, const glm::vec3 &offset,
									 const Color &color, const glm::mat4 &transform = {1.0f});
		...
		static void DrawCylinder(float radius, float height, uint32_t sides, const glm::vec3 &offset,
								 const Color &color, const glm::mat4 &transform = {1.0f});
		...
		static void DrawCapsule(float radius, float height, uint32_t sides, const glm::vec3 &offset,
								const Color &color,
